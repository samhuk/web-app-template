...
export const createBuilder = (buildName: string, builder: () => Promise<{ buildResult: BuildResult, additionalOutputs?: BuildOutput[] }>): () => Promise<{ buildResult: BuildResult, additionalOutputs: BuildOutput[] }> => () => {
